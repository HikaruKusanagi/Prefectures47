...
import 'package:prefectures47/kinki/kinki.widget/kinkiwidget.dart';
import 'package:prefectures47/kinki/kinki.widget/kinkiwidget1.dart';
import 'package:prefectures47/kinki/kinki.widget/kinkiwidget2.dart';
import 'package:prefectures47/kinki/kinki.widget/kinkiwidget3.dart';
import 'package:prefectures47/kinki/kinki.widget/kinkiwidget4.dart';
import 'package:prefectures47/kinki/kinki.widget/kinkiwidget5.dart';

class KinkiPage extends StatefulWidget {
  const KinkiPage({Key? key}) : super(key: key);

  @override
  State<KinkiPage> createState() => _KinkiPageState();
}

class _KinkiPageState extends State<KinkiPage> {
  @override
