...
import 'package:prefectures47/kanto/kantowidget.dart/kantowidget2.dart';
import 'package:prefectures47/kanto/kantowidget.dart/kantowidget3.dart';
...
class KantoPage extends StatefulWidget {
  const KantoPage({Key? key}) : super(key: key);

  @override
  State<KantoPage> createState() => _KantoPageState();
}

class _KantoPageState extends State<KantoPage> {
  @override
